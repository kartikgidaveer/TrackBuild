...
require_once '../../libraries/tcpdf/tcpdf.php'; // Path to TCPDF library
...
if (!isset($_GET['project_id'])) {
    header("Location: report_dashboard.php");
    exit();
}
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM projects WHERE id = :project_id AND user_id = :user_id");
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="../projects/engineer_project_list.php">Projects</a>
                    </li>
                    <li class="nav-item">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="report_dashboard.php">Reports</a></li>
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <h2 class="card-title">Report for <?= htmlspecialchars($project['project_name']) ?></h2>
                <p class="card-text">Below is the expense breakdown for the selected project. You can download the full
                    report as a PDF or CSV.</p>
                <hr>
                <!-- Expense Table -->
